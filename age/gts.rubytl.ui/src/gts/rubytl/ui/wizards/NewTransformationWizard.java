...
public class NewTransformationWizard extends Wizard implements INewWizard {
	public static final String ID = "gts.rubytl.ui.wizards.NewTransformationWizard";
	...
	public void addPages() {
		...
		page = new WizardNewFileCreationPage(RubytlMessages.getString("WizardNewTransformationPage.pageName"), selection);		
		page.setTitle(RubytlMessages.getString("WizardNewTransformationPage.pageTitle"));
		page.setDescription(RubytlMessages.getString("WizardNewTransformationPage.pageDescription"));
		page.setImageDescriptor(PluginImages.DESC_NEW_TRANSFORMATION_WIZARD);
		page.setFileName("meta2meta.rb");
		addPage(page);
	}

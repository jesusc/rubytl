...
public class NewRubySourceModelWizard extends Wizard implements INewWizard {
	public static final String ID = "gts.rubytl.ui.wizards.NewRubySourceModelWizard";
	 ...
	 */
	public NewRubySourceModelWizard() {
		super();
	...
	public void addPages() {
		...
		page = new WizardNewFileCreationPage(RubytlMessages.getString("WizardNewSourcePage.pageName"), selection);		
		page.setTitle(RubytlMessages.getString("WizardNewSourcePage.pageTitle"));
		page.setDescription(RubytlMessages.getString("WizardNewSourcePage.pageDescription"));
		page.setImageDescriptor(PluginImages.DESC_NEW_SOURCE_WIZARD);
		page.setFileName("source.rb");
		addPage(page);
	}

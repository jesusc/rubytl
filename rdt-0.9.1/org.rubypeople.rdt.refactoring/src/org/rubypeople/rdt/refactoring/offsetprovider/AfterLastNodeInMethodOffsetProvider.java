...
public class AfterLastNodeInMethodOffsetProvider extends OffsetProvider {

	private MethodNodeWrapper methodNode;

	public AfterLastNodeInMethodOffsetProvider(MethodNodeWrapper methodNode, String document) {
		super(document);
	...
	public Node getInsertAfterNode() {
		...
		return NodeProvider.getLastChildNode(methodContentNode);
	}

...
package org.rubypeople.rdt.refactoring.tests.core.formatsource;
...
public class TC_EditableFormatHelper extends TestCase {
	...
	private String generateSource(String original) {
		return new PreviewGeneratorImpl(original).getPreview(formatter);
	}

	private void assertEqualSource(String expectedResult, String toBeFormatted) {
		assertEquals(expectedResult, generateSource(toBeFormatted));
	}

...
//	private void handleDropMove(final Object target, DropTargetEvent event) throws RubyModelException, InvocationTargetException, InterruptedException{
//		IRubyElement[] javaElements= ReorgUtils.getRubyElements(fElements);
...
//			starter= ReorgMoveStarter.create(javaElements, resources, (IRubyElement)target);
//		if (starter != null)
...
//	private void handleDropCopy(final Object target, DropTargetEvent event) throws RubyModelException, InvocationTargetException, InterruptedException{
//		IRubyElement[] javaElements= ReorgUtils.getRubyElements(fElements);
//		IResource[] resources= ReorgUtils.getResources(fElements);
...
//		else if (target instanceof IRubyElement)
//			starter= ReorgCopyStarter.create(javaElements, resources, (IRubyElement)target);
//		if (starter != null)
//			starter.run(getShell());
//	}

...
public class CallHierarchyViewPart extends ViewPart implements ICallHierarchyViewPart,
	...
	static final String ID_CALL_HIERARCHY = "org.rubypeople.rdt.callhierarchy.view"; //$NON-NLS-1$
    ...
    public void createPartControl(Composite parent) {
        ...
        PlatformUI.getWorkbench().getHelpSystem().setHelp(fPagebook, IRubyHelpContextIds.CALL_HIERARCHY_VIEW);
    ...
    private void revealElementInEditor(Object elem, Viewer originViewer) {
        ...
        } else if (elem instanceof IRubyElement) {
...
//    		return RubyUIHelp.getHelpContextProvider(this, IRubyHelpContextIds.CALL_HIERARCHY_VIEW);
//    	}
...
//                    new RefactorActionGroup(this),
	...
	private void updateView() {
		if ( (fShownMethod != null)) {
			...
			String elementName= RubyElementLabels.getElementLabel(fShownMethod, RubyElementLabels.ALL_DEFAULT);

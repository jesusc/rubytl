...
public class WorkingSetConfigurationDialog extends SelectionDialog {
	...
	private class Filter extends ViewerFilter {
		public boolean select(Viewer viewer, Object parentElement, Object element) {
			...
			return OthersWorkingSetUpdater.ID.equals(id) ||
				RubyWorkingSetUpdater.ID.equals(id) || isCompatible(ws) || isActive(ws);
		}
	...
	private void createWorkingSet() {
		...
		IWorkingSetNewWizard wizard= manager.createWorkingSetNewWizard(new String[] {RubyWorkingSetUpdater.ID});

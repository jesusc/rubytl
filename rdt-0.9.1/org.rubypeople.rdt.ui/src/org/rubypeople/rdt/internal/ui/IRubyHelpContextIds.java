...
/**
 * Help context ids for the Ruby UI.
 * <p>
 ...
 * 
 */
public interface IRubyHelpContextIds {
	public static final String PREFIX= RubyPlugin.PLUGIN_ID + '.';
	...
	public static final String RUBY_EDITOR_PREFERENCE_PAGE= PREFIX + "ruby_editor_preference_page_context"; //$NON-NLS-1$

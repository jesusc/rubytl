...
class RemoveLinkedFolderDialog extends MessageDialog {
	...
	RemoveLinkedFolderDialog(final Shell shell, final IFolder folder) {
		super(shell, NewWizardMessages.LoadpathModifierQueries_confirm_remove_linked_folder_label, null, Messages.format(NewWizardMessages.LoadpathModifierQueries_confirm_remove_linked_folder_message, new Object[] { folder.getFullPath()}), MessageDialog.QUESTION, new String[] { IDialogConstants.YES_LABEL, IDialogConstants.NO_LABEL}, 0); // yes is the default
	...
	protected Control createCustomArea(final Composite parent) {
		...
		fRemoveBuildPathAndFolder.setText(NewWizardMessages.LoadpathModifierQueries_delete_linked_folder);
		...
		fRemoveBuildPath.setText(NewWizardMessages.LoadpathModifierQueries_do_not_delete_linked_folder);

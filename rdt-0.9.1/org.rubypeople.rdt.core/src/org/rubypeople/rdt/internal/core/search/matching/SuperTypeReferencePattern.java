...
public class SuperTypeReferencePattern extends RubySearchPattern implements IIndexConstants {
...
public boolean matchesDecodedKey(SearchPattern decodedPattern) {
	...
	if (this.superRefKind == ONLY_SUPER_CLASSES && pattern.enclosingTypeName != IIndexConstants.ONE_ZERO/*not an anonymous*/) 
		// reject modules
		if (pattern.superClassOrInterface == IIndexConstants.MODULE_SUFFIX) 
			return false;

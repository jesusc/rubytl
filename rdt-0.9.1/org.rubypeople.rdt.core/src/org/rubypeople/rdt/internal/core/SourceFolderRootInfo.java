...
//							continue nextResource;
				...
				if (nonRubyResources.length == nonJavaResourcesCounter) {
					// resize
					System.arraycopy(nonRubyResources, 0, (nonRubyResources = new IResource[nonJavaResourcesCounter * 2]), 0, nonJavaResourcesCounter);
				}
				nonRubyResources[nonJavaResourcesCounter++] = member;

			}
			if (nonRubyResources.length != nonJavaResourcesCounter) {
				System.arraycopy(nonRubyResources, 0, (nonRubyResources = new IResource[nonJavaResourcesCounter]), 0, nonJavaResourcesCounter);
			}
			return nonRubyResources;
		} catch (CoreException e) {
			throw new RubyModelException(e);
